...
const CountdownUnit = ({ value, label }: { value: number; label: string }) => (
  <div className="flex flex-col items-center">
    <div className="bg-base-200/70 backdrop-blur-md rounded-xl px-3 py-2 sm:px-4 sm:py-3 min-w-[56px] sm:min-w-[72px] shadow-lg border border-primary/20">
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold font-mono text-primary mb-4 sm:mb-6 leading-tight"
        >
          CWA Prompt-a-thon
          <br />
          <span>
        ...
        <motion.div variants={itemVariants} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
           <a href="#" className="btn btn-primary btn-lg font-semibold rounded-xl transition-all duration-300 hover:scale-105 group relative overflow-hidden">
