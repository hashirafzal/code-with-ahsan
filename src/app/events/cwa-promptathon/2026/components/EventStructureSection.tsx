    ...
    <section className="py-16 sm:py-24 relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 max-w-3xl text-center relative z-10">
        ...
        <motion.div
          ...
          variants={itemVariants}
          className="bg-base-200/70 backdrop-blur-md rounded-2xl p-6 sm:p-8 relative shadow-lg border border-base-300/60"
        >
          <motion.div
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          transition={{ delay: 0.4 }} // Added slight delay
          variants={itemVariants}
          className="mt-16 sm:mt-20 pt-8 border-t border-base-300/50"
        >
